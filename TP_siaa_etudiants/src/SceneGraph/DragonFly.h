...
namespace SceneGraph
{
	...
	private:
		...
		// Transformations
			...
			SceneGraph::Rotate * m_leftUpWingRotation;
			SceneGraph::Rotate * m_rightUpWingRotation;
			SceneGraph::Rotate * m_leftDownWingRotation;
