...
namespace Application
{
	...
	public:
		...
		SceneGraph::Group * buildChain(int chainSize, StaticNode * lastKinematicNode)
		{
			...
			lastKinematicNode = m_kinematicChainRoot.addStaticTranslation(m_kinematicChainRoot.getRoot(),firstTranslate->getTranslation());
			...
			for(int i=0; i<chainSize-1; i++)
			{
				...
				DynamicNode * dn1 = m_kinematicChainRoot.addDynamicRotation(lastKinematicNode,Math::makeVector(0,1,0),Math::makeInterval((float)-Math::pi/2,(float)Math::pi/2),0);
				DynamicNode * dn2 = m_kinematicChainRoot.addDynamicRotation(dn1,Math::makeVector(0,0,1),Math::makeInterval((float)-Math::pi/2,(float)Math::pi/2),0);
				...
				lastKinematicNode = m_kinematicChainRoot.addStaticTranslation(dn2, t2->getTranslation());
			}
