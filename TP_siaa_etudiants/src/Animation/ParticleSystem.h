...
namespace Animation
{
	...
	public:
		...
		/// </summary>
		/// <param name="budget">The particle budget (maximum number of alive particles).</param>
		...
		/// \param	deathFunction	The deathFunction.
		////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		/// \fn	static void ParticleSystem::modifierWeightForce(Particle & particle, float dt)
		///
		/// \brief	Modifier that adds a weight force on the particle.
		///
		/// \author	F. Lamarche, Université de Rennes 1
		/// \date	21/12/2015
		///
		...
		/// \param	dt					The dt.
		////////////////////////////////////////////////////////////////////////////////////////////////////
		static void modifierWeightForce(Particle & particle, float dt)
		{
			const float gravity = 9.8f ;
			particle.m_forces = particle.m_forces + Math::makeVector(0.0f,0.0f,particle.m_mass * gravity) ;
		}
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		/// \class	ModifierAttractor
		///
		/// \brief	Attractor class for particles.
		///
		/// \author	F. Lamarche, Université de Rennes 1
		/// \date	21/12/2015
		////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public:
			ModifierAttractor(const Math::Vector3f & center, float extent, float attractionForce)
			...
			void operator() (Particle & particle, float dt) const
			{
				...
				if(deltaNorm<m_extent)
				{
					...
					particle.m_forces = particle.m_forces + force ;
				}
			}
		};
