...
namespace Math
{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// \fn	Vector<Float, 2> makeVector(Float const & c1, Float const & c2)
	///
	/// \brief	Makes a 2D vector. 
	///
	/// \author	Fabrice Lamarche, University Of Rennes 1
	/// \date	23/01/2010
	///
	/// \param [in,out]	c1	the first Float const &. 
	/// \param [in,out]	c2	the second Float const &. 
	///
	/// \return	. 
	////////////////////////////////////////////////////////////////////////////////////////////////////
	template <class Float>
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// \fn	Vector<Float, 3> makeVector(Float const & c1, Float const & c2, Float const & c3)
	///
	/// \brief	Makes a 3D vector. 
	///
	/// \author	Fabrice Lamarche, University Of Rennes 1
	/// \date	23/01/2010
	///
	/// \param [in,out]	c1	the first Float const &. 
	/// \param [in,out]	c2	the second Float const &. 
	/// \param [in,out]	c3	the third Float const &. 
	///
	/// \return	. 
	////////////////////////////////////////////////////////////////////////////////////////////////////
	template <class Float>
	...
	/// \param [in,out]	c2	the second Float const &. 
	/// \param [in,out]	c3	the third Float const &. 
	/// \param [in,out]	c4	the fourth Float const &. 
	///
	/// \return	. 
	////////////////////////////////////////////////////////////////////////////////////////////////////
	template <class Float>
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// \fn	Vector<Float, 5> makeVector(Float const & c1, Float const & c2, Float const & c3,
	/// 	Float const & c4, Float const & c5)
	///
	/// \brief	Makes a 5D vector. 
	///
	/// \author	Fabrice Lamarche, University Of Rennes 1
	/// \date	23/01/2010
	///
	...
	/// \param [in,out]	c3	the third Float const &. 
	/// \param [in,out]	c4	the fourth Float const &. 
	/// \param [in,out]	c5	the fifth Float const &. 
	///
	/// \return	. 
	////////////////////////////////////////////////////////////////////////////////////////////////////
	template <class Float>
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	/// \property	inline std::ostream & operator<< (std::ostream & out, Vector<Float,
	/// 			dimensions> const & v)
	///
	/// \brief	Prints a vector in an ostream (principally for debug purpose).
	///
	/// \return	the ostream
	////////////////////////////////////////////////////////////////////////////////////////////////////
	template <class Float, int dimensions>
